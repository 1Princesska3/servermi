...
{
    private string Masterserver = "23466";
    private string Facilitator = "50005";
    ...
    void Start()
    {
        ...
        MasterServer.port = int.Parse(Masterserver);
        Network.natFacilitatorIP = "127.0.0.1";
        Network.natFacilitatorPort = int.Parse(Facilitator);
    }
